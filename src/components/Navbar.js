...
export default function Navbar(props) {
  return (
    <>
      <nav className={`navbar navbar-expand-lg  bg-${props.mode==='light'?'light':'secondary'}`}>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <Link className={`nav-link active text-${props.mode==='light'?'black':'white'}`} aria-current="page" to="/">
                  Home
                </Link>
              </li>
              <li className="nav-item">
